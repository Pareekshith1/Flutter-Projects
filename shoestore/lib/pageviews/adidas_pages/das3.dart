...
class Das3 extends StatelessWidget {
  const Das3({Key? key}) : super(key: key);
...
class Das3Page extends StatelessWidget {
  const Das3Page({Key? key}) : super(key: key);
        ...
        child: Column(
          children: [
            Container(
              ...
              child: Image.asset('assets/images/adidasa3.png'),
            ),
            Container(
              width: MediaQuery.of(context).size.width,
              height: 450,
                                  ...
                                  Padding(
                                    ...
                                    child: Container(
                                      ...
                                      decoration: BoxDecoration(
                                        borderRadius:
                                            BorderRadius.circular(100),
                                        color: Color.fromARGB(255, 135, 99, 6),
                                      ),
                                    ),
                                  ),
                                ],
