...
class Das1 extends StatelessWidget {
  const Das1({Key? key}) : super(key: key);
...
class Das1Page extends StatelessWidget {
  const Das1Page({Key? key}) : super(key: key);
        ...
        child: Column(
          children: [
            Container(
              ...
              child: Image.asset('assets/images/adidas1.png'),
            ),
            Container(
              width: MediaQuery.of(context).size.width,
              height: 450,
