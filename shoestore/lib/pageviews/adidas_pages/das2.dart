...
class Das2 extends StatelessWidget {
  const Das2({Key? key}) : super(key: key);
...
class Das2Page extends StatelessWidget {
  const Das2Page({Key? key}) : super(key: key);
        ...
        child: Column(
          children: [
            Container(
              ...
              child: Image.asset('assets/images/adidas2.png'),
            ),
            Container(
              width: MediaQuery.of(context).size.width,
              height: 450,
