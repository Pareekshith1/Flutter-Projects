...
class Das5 extends StatelessWidget {
  const Das5({Key? key}) : super(key: key);
...
class Das5Page extends StatelessWidget {
  const Das5Page({Key? key}) : super(key: key);
        ...
        child: Column(
          children: [
            Container(
              ...
              child: Image.asset('assets/images/adidas5.png'),
            ),
            Container(
              width: MediaQuery.of(context).size.width,
              height: 450,
                                  ...
                                  Padding(
                                    ...
                                    child: Container(
                                      ...
                                      decoration: BoxDecoration(
                                        ...
                                        color: Color.fromARGB(255, 172, 5, 5),
                                      ),
                                    ),
                                  ),
                                  // Yellow circle
