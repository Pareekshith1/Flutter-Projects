...
class Pum4 extends StatelessWidget {
  const Pum4({Key? key}) : super(key: key);
...
class Pum4Page extends StatelessWidget {
  const Pum4Page({Key? key}) : super(key: key);
        ...
        child: Column(
          children: [
            Container(
              ...
              child: Image.asset('assets/images/puma4.png'),
            ),
            Container(
              width: MediaQuery.of(context).size.width,
              height: 450,
