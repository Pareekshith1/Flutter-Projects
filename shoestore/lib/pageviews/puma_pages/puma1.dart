...
class Pum1 extends StatelessWidget {
  const Pum1({Key? key}) : super(key: key);
...
class Pum1Page extends StatelessWidget {
  const Pum1Page({Key? key}) : super(key: key);
        ...
        child: Column(
          children: [
            Container(
              ...
              child: Image.asset('assets/images/puma1.png'),
            ),
            Container(
              width: MediaQuery.of(context).size.width,
              height: 450,
