...
class Pum5 extends StatelessWidget {
  const Pum5({Key? key}) : super(key: key);
...
class Pum5Page extends StatelessWidget {
  const Pum5Page({Key? key}) : super(key: key);
        ...
        child: Column(
          children: [
            Container(
              ...
              child: Image.asset('assets/images/puma5.png'),
            ),
            Container(
              width: MediaQuery.of(context).size.width,
              height: 450,
