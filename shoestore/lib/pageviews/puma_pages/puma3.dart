...
class Pum3 extends StatelessWidget {
  const Pum3({Key? key}) : super(key: key);
...
class Pum3Page extends StatelessWidget {
  const Pum3Page({Key? key}) : super(key: key);
        ...
        child: Column(
          children: [
            Container(
              ...
              child: Image.asset('assets/images/puma3.png'),
            ),
            Container(
              width: MediaQuery.of(context).size.width,
              height: 450,
