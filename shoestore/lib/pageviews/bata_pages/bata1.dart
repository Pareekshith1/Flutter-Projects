...
class Bat1 extends StatelessWidget {
  const Bat1({Key? key}) : super(key: key);
...
class Bat1Page extends StatelessWidget {
  const Bat1Page({Key? key}) : super(key: key);
        ...
        child: Column(
          children: [
            Container(
              ...
              child: Image.asset('assets/images/bata1.png'),
            ),
            Container(
              width: MediaQuery.of(context).size.width,
              height: 450,
                                  ...
                                  Padding(
                                    ...
                                    child: Container(
                                      ...
                                      decoration: BoxDecoration(
                                        borderRadius:
                                            BorderRadius.circular(100),
                                        color: Color.fromARGB(255, 139, 92, 3),
                                      ),
                                    ),
                                  ),
                                ],
