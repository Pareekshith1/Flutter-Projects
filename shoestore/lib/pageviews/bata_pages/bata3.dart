...
class Bat3 extends StatelessWidget {
  const Bat3({Key? key}) : super(key: key);
...
class Bat3Page extends StatelessWidget {
  const Bat3Page({Key? key}) : super(key: key);
        ...
        child: Column(
          children: [
            Container(
              ...
              child: Image.asset('assets/images/bata3.png'),
            ),
            Container(
              width: MediaQuery.of(context).size.width,
              height: 450,
