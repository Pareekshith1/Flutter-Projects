...
class Bat4 extends StatelessWidget {
  const Bat4({Key? key}) : super(key: key);
...
class Bat4Page extends StatelessWidget {
  const Bat4Page({Key? key}) : super(key: key);
        ...
        child: Column(
          children: [
            Container(
              ...
              child: Image.asset('assets/images/bata4.png'),
            ),
            Container(
              width: MediaQuery.of(context).size.width,
              height: 450,
                                    ...
                                    child: Container(
                                      ...
                                      decoration: BoxDecoration(
                                        borderRadius:
                                            BorderRadius.circular(100),
                                        color:
                                            Color.fromARGB(255, 152, 125, 125),
                                      ),
                                    ),
                                  ),
                                ],
