...
class Bat5 extends StatelessWidget {
  const Bat5({Key? key}) : super(key: key);
...
class Bat5Page extends StatelessWidget {
  const Bat5Page({Key? key}) : super(key: key);
        ...
        child: Column(
          children: [
            Container(
              ...
              child: Image.asset('assets/images/bata5.png'),
            ),
            Container(
              width: MediaQuery.of(context).size.width,
              height: 450,
