...
class Air4 extends StatelessWidget {
  const Air4({Key? key}) : super(key: key);
...
class Air4Page extends StatelessWidget {
  const Air4Page({Key? key}) : super(key: key);
        ...
        child: Column(
          children: [
            Container(
              ...
              child: Image.asset('assets/images/jordans4.png'),
            ),
            Container(
              width: MediaQuery.of(context).size.width,
              height: 450,
                                  ...
                                  Padding(
                                    ...
                                    child: Container(
                                      ...
                                      decoration: BoxDecoration(
                                        borderRadius:
                                            BorderRadius.circular(100),
                                        color: Color.fromARGB(255, 17, 53, 184),
                                      ),
                                    ),
                                  ),
                                ],
