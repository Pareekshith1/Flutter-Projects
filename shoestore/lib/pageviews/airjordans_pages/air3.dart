...
class Air3 extends StatelessWidget {
  const Air3({Key? key}) : super(key: key);
...
class Air3Page extends StatelessWidget {
  const Air3Page({Key? key}) : super(key: key);
        ...
        child: Column(
          children: [
            Container(
              ...
              child: Image.asset('assets/images/jordans3.png'),
            ),
            Container(
              width: MediaQuery.of(context).size.width,
              height: 450,
                                  ...
                                  Padding(
                                    ...
                                    child: Container(
                                      ...
                                      decoration: BoxDecoration(
                                        borderRadius:
                                            BorderRadius.circular(100),
                                        color: Color.fromARGB(255, 176, 32, 3),
                                      ),
                                    ),
                                  ),
                                ],
