...
class Air2 extends StatelessWidget {
  const Air2({Key? key}) : super(key: key);
...
class Air2Page extends StatelessWidget {
  const Air2Page({Key? key}) : super(key: key);
        ...
        child: Column(
          children: [
            Container(
              ...
              child: Image.asset('assets/images/jordans2.png'),
            ),
            Container(
              width: MediaQuery.of(context).size.width,
              height: 450,
