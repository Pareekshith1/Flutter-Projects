...
class Air1 extends StatelessWidget {
  const Air1({Key? key}) : super(key: key);
...
class Air1Page extends StatelessWidget {
  const Air1Page({Key? key}) : super(key: key);
        ...
        child: Column(
          children: [
            Container(
              ...
              child: Image.asset('assets/images/jordans1.png'),
            ),
            Container(
              width: MediaQuery.of(context).size.width,
              height: 450,
