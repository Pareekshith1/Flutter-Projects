...
class Air5 extends StatelessWidget {
  const Air5({Key? key}) : super(key: key);
...
class Air5Page extends StatelessWidget {
  const Air5Page({Key? key}) : super(key: key);
        ...
        child: Column(
          children: [
            Container(
              ...
              child: Image.asset('assets/images/jordans5.png'),
            ),
            Container(
              width: MediaQuery.of(context).size.width,
              height: 450,
