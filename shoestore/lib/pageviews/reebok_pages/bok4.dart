...
class Bok4 extends StatelessWidget {
  const Bok4({Key? key}) : super(key: key);
...
class Bok4Page extends StatelessWidget {
  const Bok4Page({Key? key}) : super(key: key);
        ...
        child: Column(
          children: [
            Container(
              ...
              child: Image.asset('assets/images/reebok4.png'),
            ),
            Container(
              width: MediaQuery.of(context).size.width,
              height: 450,
