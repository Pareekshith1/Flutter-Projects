...
class Bok1 extends StatelessWidget {
  const Bok1({Key? key}) : super(key: key);
...
class Bok1Page extends StatelessWidget {
  const Bok1Page({Key? key}) : super(key: key);
        ...
        child: Column(
          children: [
            Container(
              ...
              child: Image.asset('assets/images/reebok1.png'),
            ),
            Container(
              width: MediaQuery.of(context).size.width,
              height: 450,
                                  ...
                                  Padding(
                                    ...
                                    child: Container(
                                      ...
                                      decoration: BoxDecoration(
                                        ...
                                        color: Color.fromARGB(255, 4, 104, 180),
                                      ),
                                    ),
                                  ),
                                  // Yellow circle
                                  Padding(
                                    ...
                                    child: Container(
                                      ...
                                      decoration: BoxDecoration(
                                        borderRadius:
                                            BorderRadius.circular(100),
                                        color: Color.fromARGB(255, 6, 109, 134),
                                      ),
                                    ),
                                  ),
                                ],
