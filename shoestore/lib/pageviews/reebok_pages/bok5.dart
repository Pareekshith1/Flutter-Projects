...
class Bok5 extends StatelessWidget {
  const Bok5({Key? key}) : super(key: key);
...
class Bok5Page extends StatelessWidget {
  const Bok5Page({Key? key}) : super(key: key);
        ...
        child: Column(
          children: [
            Container(
              ...
              child: Image.asset('assets/images/reebok5.png'),
            ),
            Container(
              width: MediaQuery.of(context).size.width,
              height: 450,
