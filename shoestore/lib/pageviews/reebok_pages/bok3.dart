...
class Bok3 extends StatelessWidget {
  const Bok3({Key? key}) : super(key: key);
...
class Bok3Page extends StatelessWidget {
  const Bok3Page({Key? key}) : super(key: key);
        ...
        child: Column(
          children: [
            Container(
              ...
              child: Image.asset('assets/images/reebok3.png'),
            ),
            Container(
              width: MediaQuery.of(context).size.width,
              height: 450,
