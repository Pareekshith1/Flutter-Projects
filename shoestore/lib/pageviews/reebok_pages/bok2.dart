...
class Bok2 extends StatelessWidget {
  const Bok2({Key? key}) : super(key: key);
...
class Bok2Page extends StatelessWidget {
  const Bok2Page({Key? key}) : super(key: key);
        ...
        child: Column(
          children: [
            Container(
              ...
              child: Image.asset('assets/images/reebok2.png'),
            ),
            Container(
              width: MediaQuery.of(context).size.width,
              height: 450,
